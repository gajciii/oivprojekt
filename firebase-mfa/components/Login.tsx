...
export function Login({loginWithGoogle, loginWithEmailAndPassword}: Props) {
    ...
    return (
        <div className="bg-white md:w-[500px] rounded-xl p-8">
            <h2 className="mt-20 mb-8 text-3xl font-bold text-center text-gray-800">Dobrodošli nazaj</h2>
            <button
            ...
            >
                <div className="space-y-4">
                    <div className="relative flex items-center">
                        ...
                        <input
                            ...
                            type="email"
                            name="email"
                            placeholder="Vpišite svoj email"
                ...
                <div className="space-y-4 my-6">
                    <div className="relative flex items-center">
                        ...
                        <input
                            ...
                            name="password"
                            id="password"
                            placeholder="Vpišite svoje geslo"
                ...
                <p className="border-t border-gray-100 pt-6 text-center text-sm text-gray-500">
                    Nimate računa ?<Link href="/sign-up" className="text-black"> Registracija</Link>
                </p>
            </form>
        </div>
    )
