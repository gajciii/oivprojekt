    ...
    return (
        <div className="bg-white flex flex-col p-5 md:p-6  border-2 border-palladium rounded-xl w-full sm:max-w-[440px]">
            <div className="flex justify-between">
                <div>
                    <h1 className='font-medium text-[22px] leading-[130%] md:mr-8'>Potrdite telefonsko številko</h1>
                    <p className='text-slate-500 mt-2 text-base'>Poslali smo vam SMS na vašo telefonsko številko.</p>
                </div>
            </div>
